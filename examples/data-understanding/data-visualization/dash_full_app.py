    ...
    [
        ...
        html.Div([
            ...
            dcc.Checklist(
                ...
                value=transmission_types,  # Fixed: changed 'vlaue' to 'value'
...
def update_figure(year_range, transmission_list, selectedData, n_clicks):
    ...
    if n_clicks > total_clicks:
        fig_scatter.update_traces(selected_marker_color=None)  # Fixed: changed 'selselected_marker_color' to 'selected_marker_color'
